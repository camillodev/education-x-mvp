    ...
    content = (
      <MScreen step={2} onBack={() => setStep(1)}
        ...
        body={<>
          ...
          <p style={{ margin: "0 0 18px", fontSize: 14, color: "var(--color-text-muted)" }}>{materias.length} matéria{materias.length > 1 ? "s" : ""} · quanto mais longo, maior o desconto.</p>
          ...
          <div style={{ padding: 18, borderRadius: "var(--radius-md)", background: "var(--color-primary)", color: "#fff" }}>
            <div style={{ fontSize: 13, opacity: 0.85, fontWeight: 600 }}>Mensalidade com este plano</div>
            ...
            {planoObj.id !== "mensal" && (() => {
              ...
              const economia = (mensal.parcela - planoObj.parcela) * planoObj.meses;
